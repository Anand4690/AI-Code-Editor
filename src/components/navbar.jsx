...
const Navbar = () => {
  ...
  <button className="text-slate-100  py-2 font-medium tracking-wide text-lg flex items-center space-x-2">
    <span>Login</span>
    <svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960" width="48px" fill="#999999">
